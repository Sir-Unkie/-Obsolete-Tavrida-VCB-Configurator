...
const initialState = {
  Customization: {
    value: '0',
    options: [{ 0: 'Not set' }, { 1: 'No customization' }],
    adjustedOptions: [{ 0: 'Not set' }, { 1: 'No customization' }],
    blocks: [{ 0: [] }, { 1: [] }],
  },
  'Rated voltage': {
    value: '0',
  ...
  'Rated normal current': {
    value: '0',
    options: [{ 0: 'Not set' }, { 1: '2500 A' }, { 2: '3150 A' }],
    adjustedOptions: [{ 0: 'Not set' }, { 1: '2500 A' }, { 2: '3150 A' }],
    blocks: [{ 0: [] }, { 1: [] }, { 2: [{ 'Pole center distance': [1] }] }],
  },
  'Pole center distance': {
    value: '0',
    options: [{ 0: 'Not set' }, { 1: '210 mm' }, { 2: '275 mm' }],
    adjustedOptions: [{ 0: 'Not set' }, { 1: '210 mm' }, { 2: '275 mm' }],
    blocks: [
      { 0: [] },
      {
        1: [{ 'Rated normal current': [2] }],
      },
      {
        2: [],
      },
...
export const HDvcbSlice = createSlice({
  name: 'HDvcb',
  initialState,
  reducers: {
...
export const { changed, clear } = HDvcbSlice.actions;

export default HDvcbSlice.reducer;
